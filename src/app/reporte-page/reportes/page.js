const ReportesPage = () => {
    return(
<div class="max-w-[720px] mx-auto mt-32">
    <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
        <div>
            <h3 class="text-lg font-semibold text-slate-800">Reportes</h3>
            <p class="text-slate-500">Listado de todos los reportes</p>
        </div>
        <div class="ml-3">
    ...
    <table class="w-full text-left table-auto min-w-max">
        ...
        <tr class="hover:bg-slate-50 border-b border-slate-200">
            <td class="p-4 py-5">
            <p class="block font-semibold text-sm text-slate-800">0001</p>
            </td>
            <td class="p-4 py-5">
            <p class="text-sm text-slate-500">Uzziel Aparicio</p>
            </td>
            <td class="p-4 py-5">
            <p class="text-sm text-slate-500">Ser gay</p>
            </td>
            <td class="p-4 py-5">
            <p class="text-sm text-slate-500">Activo</p>
            </td>
            <td class="p-4 py-5">
            <p class="text-sm text-slate-500">2020-01-01</p>
            </td>
        </tr>
        </tbody>
    </table>
